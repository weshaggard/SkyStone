...
public class SampleMecanumDriveREVOptimized extends SampleMecanumDriveBase {
    ...
    public SampleMecanumDriveREVOptimized(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(ExpansionHubMotor.class, "FrontLeftDrive");
        leftRear = hardwareMap.get(ExpansionHubMotor.class, "RearLeftDrive");
        rightRear = hardwareMap.get(ExpansionHubMotor.class, "RearRightDrive");
        rightFront = hardwareMap.get(ExpansionHubMotor.class, "FrontRightDrive");
