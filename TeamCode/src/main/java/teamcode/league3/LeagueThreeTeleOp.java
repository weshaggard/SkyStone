...
public class LeagueThreeTeleOp extends AbstractOpMode {
    ...
    private double SPRINT_SPEED_MODIFIER = 1.0;
    ...
    private void driveUpdate() {
        ...
        if(gamepad1.left_trigger > 0.3){
            velocity = new Vector2D(gamepad1.right_stick_x * SPRINT_SPEED_MODIFIER, gamepad1.right_stick_y * SPRINT_SPEED_MODIFIER);
